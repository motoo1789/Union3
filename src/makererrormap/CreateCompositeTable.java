...
public class CreateCompositeTable implements ProductTable{
	...
	final String Role[] = {"Micro-Structure＼Class","Composite","Component","Leaf"};
	final String MicroStructure[] = {"Inheritance", "Aggregation", "OverRide","Classname"};
	String[][] TableData = {
			{"○"," ","○"},
			{"○"," "," "},
			{"○"," ","○"},
...
//		gd.widthHint = 600;
		...
		table.addMouseTrackListener(new MouseTrackListener() {
			...
			public void mouseEnter(MouseEvent e) {
				...
				String moveMouse = "CompositeのMapにのった:";
			...
			public void mouseExit(MouseEvent e) {
				...
				String date = saveObject.getDate();
				String moveMouse = "CompositeのMapから離れた:";
	...
	public void makeTableData(Map<String, String> tabledata) {
		...
		{
			System.out.println("Composite:makeTableDataより引数がnull" );
		}
	}
